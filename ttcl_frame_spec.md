...
> GITMO trigger (code 0x56) is generated by the [MTRG GITMO module](vhdl/MTRG_GITMO.md) which interfaces external Gammasphere NIM signals.
...
- Similar to Frame 12 but targets [Digitizer Tester](digitizer_tester.md) boards and [MγRIAD](myriad.md) boards
...
- Reserved for **non-digitizer front-end devices** (not [MγRIAD](myriad.md); for MγRIAD use Frame 14)
