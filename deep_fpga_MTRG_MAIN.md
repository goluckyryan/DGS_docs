...
- `knowledgeBase/multi_system_linking.md` — Cross-system clock/trigger sharing via Link L/R/U; MTRG ImpSync (0x840 b6) and clock-source selection (0x814 b15) are key registers in multi-system setups
