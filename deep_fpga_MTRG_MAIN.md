...
- `dgs/fpga.md` — System-level overview: trigger hierarchy, 20-frame cycle, end-to-end timeline
- `dgs/deep_fpga_MTRG.md` — MTRG overview: device layout (Main FPGA + VME FPGA + CPLD)
- `dgs/deep_fpga_MTRG_VME.md` — VME FPGA: A32/D32 VME slave, FPGA config manager
- `dgs/deep_fpga_MTRG_CPLD.md` — CPLD: fast strobe multiplicity logic (~1 µs latency)
- `dgs/deep_fpga_MTRG_VIVADO.md` — Vivado port: Kintex UltraScale XCK060 differences
- `dgs/deep_fpga_RTRG.md` — RTRG firmware: multiplicity data the MTRG receives on Link L
- `dgs/ttcl.md` — TTCL spec: 20-frame downstream command structure generated by the MTRG
- `dgs/myriad.md` — MγRIAD auxiliary detector interface (connects to MTRG trigger algorithms)
- `dgs/connectors.md` — MTRG connector pinouts: 125-pin SERDES, NIM I/O, CPLD ribbons, ECL
