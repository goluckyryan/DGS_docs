...
- [`EPICS.md`](EPICS.md) — General EPICS framework, record types, Channel Access
- [`EPICS_DB_templates.md`](EPICS_DB_templates.md) — DGS-specific DB template details (dgsGlobals, fanout structure)
- [`EPICS_RTrig_templates.md`](EPICS_RTrig_templates.md) — RTrig register template PVs
- [`IOC_cmd.md`](IOC_cmd.md) — IOC startup scripts and commands
- [`ANLDAQ.md`](ANLDAQ.md) — DAQ GUI (PyQt6) that reads and displays the PVs generated by this workflow
- [`ANLDAQ_commander.md`](ANLDAQ_commander.md) — commander.py run control GUI; top-level consumer of DGS PVs
