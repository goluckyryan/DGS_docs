...
- [collectorboxpi.md](collectorboxpi.md) — Collector box Pi IOC; detector assignments per box (SE/SW/NE/NW)
- [collectorbox_PVs.md](collectorbox_PVs.md) — PV naming uses GS hole number (e.g. `GS001_...` through `GS110_...`)
- [influxdb_grafana.md](influxdb_grafana.md) — Temperature monitoring per GS hole (`gsid=NNN` tag in InfluxDB)
- [sbx.md](sbx.md) — Slope Box Extension; GS_ID dongle encodes hole number for BGO HV addressing
- [hardware_architecture.md](hardware_architecture.md) — System topology; 110 GS holes × 4 signals (1 Ge + 3 BGO)
