...
|--------|--------|------|---------|
| MTRG Main FPGA (ISE) | xc4vlx80 (Virtex-4 LX80) | Xilinx ISE | 14.7 |
| MTRG Main FPGA (Vivado) | xcku060 (Kintex UltraScale) | Xilinx Vivado | 2018.3 |
| MTRG VME FPGA | xc3s400 (Spartan-3) | Xilinx ISE | 14.7 |
| RTRG Main FPGA | xc4vlx80 (Virtex-4 LX80) | Xilinx ISE | 14.7 |
| DIG Main FPGA | xc3s5000 (Spartan-3) | Xilinx ISE | 14.7 |
...
| Module | Project File |
|--------|-------------|
| MTRG Main FPGA | `MTRG/Firmware/MAIN_FPGA/trunk/Work13_4/Work13_4.xise` |
| MTRG VME FPGA | `MTRG/Firmware/VME_FPGA/A32D32_VME_FPGA/Work13.4/vme_A32_D32.xise` |
| RTRG Main FPGA | `RTRG/Firmware/DGS_Version/Rtr4704_mod_for_reset/MAIN_FPGA_4704_mod/Work13_4/Work13_4.xise` |
